...
public class CommandCoralElevator implements Subsystem {
    ...
    /* Motor objects */
    private final SparkMax LiftMotor = new SparkMax(14, MotorType.kBrushless); // Elevator lift motor
    ...
    private static final double SPOOL_RADIUS = 1.5; // Radius of the spool in inches
